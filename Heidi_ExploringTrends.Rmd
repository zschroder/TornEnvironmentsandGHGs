...
#1990s 
CO2_90avg = mean(AnnGHG[seq(32,41),2]) 
CH4_90avg = mean(AnnGHG[seq(32,41),3])
N2O_90avg = mean(AnnGHG[seq(32,41),4]) 
SF6_90avg = mean(AnnGHG[seq(32,41),5]) 
O3_90avg = mean(AnnGHG[seq(32,41),6]) 
AGGI_90avg = mean(AnnGHG[seq(32,41),7]) 
...
#2000s 
CO2_00avg = mean(AnnGHG[seq(42,51),2]) 
CH4_00avg = mean(AnnGHG[seq(42,51),3])
N2O_00avg = mean(AnnGHG[seq(42,51),4]) 
SF6_00avg = mean(AnnGHG[seq(42,51),5]) 
O3_00avg = mean(AnnGHG[seq(42,51),6]) 
AGGI_00avg = mean(AnnGHG[seq(42,51),7]) 
...
#2010s
CO2_10avg = mean(AnnGHG[seq(52,61),2]) 
CH4_10avg = mean(AnnGHG[seq(52,61),3])
N2O_10avg = mean(AnnGHG[seq(52,61),4]) 
SF6_10avg = mean(AnnGHG[seq(52,61),5]) 
O3_10avg = mean(AnnGHG[seq(52,61),6]) 
AGGI_10avg = mean(AnnGHG[seq(52,61),7]) 
...
#2020s 
CO2_20avg = mean(AnnGHG[seq(62,71),2]) 
CH4_20avg = mean(AnnGHG[seq(62,71),3])
N2O_20avg = mean(AnnGHG[seq(62,71),4]) 
SF6_20avg = mean(AnnGHG[seq(62,71),5]) 
O3_20avg = mean(AnnGHG[seq(62,71),6]) 
AGGI_20avg = mean(AnnGHG[seq(62,71),7]) 
...
CO2 = data.frame(CO2_90avg, CO2_00avg, CO2_10avg, CO2_20avg)
year= data.frame(1990, 2000, 2010, 2020)

#Figure for 10 year averages
ggplot(data = CO2)+
  geom_bar(mapping=aes(x=year, y=CO2),stat="identity",position = "dodge",  fill="red", width=0.9)+
  #stat_smooth(method = "lm", formula= y~x, geom = "smooth", color="black", linewidth=1.5)+
  theme_bw()+
  xlab("Years Recorded")+
  ylab("03 (DU)")+
