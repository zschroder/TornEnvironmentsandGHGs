...
```{r}
#creating grouping for average number of outbreaks per year
...
```{r}
#creating a bar graph with regression line for average T-Outbreaks per year
...
#the 03 graph is having issues 
 O3_avg<-ggplot(BigDays.sfdfT,aes(x=Year, y=O3_1year))+
   ...
   ylab("Average of O3")+
   scale_x_continuous(expand=c(0,0), limits=c(1993, 2022), breaks=seq(1993,2022,5))+
   scale_y_continuous(expand=c(0,0), limits=c(90,175), breaks=seq(90,175, 20))
