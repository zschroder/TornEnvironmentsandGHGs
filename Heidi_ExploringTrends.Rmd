...
# ggplot(AnnGHG, aes(x=year, y=CO2_ppm))+
#   geom_bar(mapping = aes(x=years),stat="identity",position = "stack",  fill="orange", width=0.9)+
#   theme_bw()+
#   xlab("Years Recorded")+
#   ylab("CO2 (ppm)")+
#   scale_x_continuous(expand=c(0,0), limits=c(1980,2030), breaks=c(seq(1980, 2030, 10)))+
