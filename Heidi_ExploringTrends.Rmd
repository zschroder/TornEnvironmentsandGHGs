...
BigDays.sfdfT%>%
  count(Year,CO2_1year)%>%
  ggplot(mapping=aes(x=Year,y=CO2_1year))+
    geom_line(aes(x=Year, y=CO2_1year), color="plum3", linewidth=1)+
    theme_bw()+
    scale_x_continuous(expand = c(0,0),limits=c(1994,2022), breaks=seq(1994,2022,2))+
    scale_y_continuous(expand = c(0, 0), limits=c(345, 415), breaks = seq(350, 415, 10))
