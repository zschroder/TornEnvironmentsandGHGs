...
grid.arrange(CO2_avg, CH4_avg, N2O_avg, SF6_avg, O3_avg, AGGI_avg,  ncol=3, top ="Annual Averages of Greenhouse Gases")
...
print(BigDays.sf.dfT)
coordinates <- BigDays.sf.dfT[,"Lat","Lon"] #milrad helped with this
print(coordinates)
#BigDays.sf.dfT <- st_as_sf(BigDays.sfdfT)
