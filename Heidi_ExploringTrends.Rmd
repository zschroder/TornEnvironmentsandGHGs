...
filter(BigDayCentroids.df, 
       cDate <- as.Date >= "1999-04-01", 
       cDate<-as.Date <= "1999-04-30")
```
...
GHG_Out <-BigDays.sfdfT%>%
  ...
  summarize(Avg1_CO2=mean(CO2_1year),
            Avg1_CH4=mean(CH4_1year),
            Avg1_O3=mean(O3_1year),
            Avg1_AGGI=mean(AGGI_1year),
            
            #10-Year Averages
            Avg10_CO2=mean(CO2_10year),
            Avg10_CH4=mean(CH4_10year),
            Avg10_O3=mean(O3_10year),
            Avg10_AGGI=mean(AGGI_10year),
            ...
            T_FO = mean(n0), 
            T_F1= mean(n1), 
            T_F2 = mean(n2),T_F3 = mean(n3), 
            T_F4 = mean(n4), T_F5 = mean(n5),
