...
for(i in 1:length(slug)){
  ...
  CAPE <- raster(rb, layer = 377) #375
  sbCAPE <- raster(rb, layer = 317) #315
  DEW <- raster(rb, layer = 290)
  MR <- raster(rb, layer = 289)
  HLCY <- raster(rb, layer = 325) #323
  CIN <- raster(rb, layer = 378) #376
  sbCIN <- raster(rb, layer = 318) #316
  USTM <- raster(rb, layer = 326) #324
  VSTM <- raster(rb, layer = 327) #325
